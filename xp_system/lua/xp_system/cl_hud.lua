...
-- Updated to fix console spam on 2025-05-23 17:27:41 by JamieL25
...
-- Override config to force HUD always visible without causing console spam
timer.Create("XPSystem_ForceHUDVisible", 1, 0, function()
    if XPSystem and XPSystem.Config and XPSystem.Config.HUD then
        ...
        -- Debug print removed to fix console spam
    end
end)
...
hook.Add("PlayerInitialSpawn", "XPSystem_InitHUD", function(ply)
    if ply == LocalPlayer() then
        ...
        -- Debug message removed to fix console spam
    end
end)
...
hook.Add("HUDPaint", "XPSystem_DrawHUD", function()
    ...
    -- Debug data line removed to fix console spam
...
-- Debug timer removed to fix console spam